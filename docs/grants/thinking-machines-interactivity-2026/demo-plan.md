...
Scenario: a desk/classroom-style scripted scene.

1. Android phone is paired as a ClawSense sensory node.
2. The phone observes a short scripted interaction:
   - a visible object or document is placed on the desk
   - a short spoken instruction is given
   - a short whiteboard or screen clue is visible
